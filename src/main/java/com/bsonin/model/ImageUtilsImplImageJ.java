...
public class ImageUtilsImplImageJ implements ImageUtils {
	...
	public AsciiArt createAsciiArt(Image image) {
		int stretchFactor = 3;
		AsciiArt asciiArt = new AsciiArt(image.getWidth() * stretchFactor, image.getHeight());
	...
	public static int getAsciiArtStretchedIndex(int stretchFactor, int loopCounter, int imagePositionX) {
